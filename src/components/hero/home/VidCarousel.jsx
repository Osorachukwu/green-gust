...
export default function VidCarousel() {
  ...
  return (
    <div className="w-full -z-50" id="top">
      ...
      >
        <CarouselContent>
          <CarouselItem>
            <div className="relative p-1 h-[500px] md:h-[95vh] bg-cover bg-center">
              <video
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center">
                <div className="text-white p-4 lg:pl-32 md:pt-40">
                  ...
                  <p className="mt-2 text-sm md:text-lg md:mt-5">
                    ...
                    communities while delivering long-term economic value to
                    our stakeholders.
                  </p>
                  <div className="mt-20">
                    <Link href="/about">
